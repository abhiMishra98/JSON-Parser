...
// Define a struct for a single set of coordinates
//typedef struct {
//    int x1, y1, x2, y2;
//} Coordinate;
//
//// Define the Drawer struct
//typedef struct {
//    char* color;               // Dynamically allocated string for color
//    Coordinate* coords;        // Dynamically allocated array of coordinates
//    uint8_t num_coords;            // Number of coordinate sets stored
//    size_t capacity;              // Current capacity of the coords array
//} drawer_t;
...
/**
* Initialises the drawer object
* \param drawer_t *drawer : [IN] drawer object
* \return RC_t: RC_SUCCESS in case of no error else error code
*/
RC_t initDrawer(drawer_t* drawer);

/**
* Function to free the drawer object
* \param drawer_t *drawer : [IN] drawer Object
* \return RC_t: RC_SUCCESS in case of no error else error code
*/
RC_t freeDrawer(drawer_t* drawer);
