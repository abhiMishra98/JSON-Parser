...
/**
* Inits the message object 
* \param message_t *me : [IN] message_t Object
* \return RC_t: RC_SUCCESS in case of no error else error code
*/
RC_t initMessage(message_t *me);

/**
* Creates the message object 
* \param message_t *me : [IN] message_t Object
* \param uint16_t size : [IN] size of the message
* \param *drawerInput drawer_t : [IN] drawerInput message object
* \return RC_t: RC_SUCCESS in case of no error else error code
*/
RC_t createMessage(message_t * me, uint16_t size, drawer_t *drawerInput);
